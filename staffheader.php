...
?>
 ...
 <nav  class="navbar navbar-expand-lg navbar-light px-5" style="background: #fff; box-shadow: 0 .5rem 1.5rem rgba(0,0,0,.1); top: 0; left: 0; right: 0;">
    ...
    <a href=" " class="logo" style="color:#000000; font-size: 1.5rem; font-weight: bolder;"><i class="fas-fa-untensils" style="color:#a9130c;"></i>GASAA Pharmacy Staff Panel</a>  
    </a>
        ...
        if(isset($_SESSION['user_id'])){
          ...
          <?php
            ...
            <a href="logout.php" style="text-decoration:none;">
                    <i class="fa fa-sign-out mr-5" style="font-size:30px; color:#000000;" aria-hidden="true"></i>
            </a>
